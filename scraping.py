...
#             # "Subprocessor":{"json_file":"json_files/subprocessor.json","link":r"https://greaterthan.eu/wp-content/uploads/Personal-Data-Sub-Processor-Agreement-2024-01-24.pdf"} 
#         }
#         temp_agreement= "temp_agreement.pdf"
        
#         for key, value in DOCUMENT_MAP.items():
#             # dealing with respective agreement only
#             scrape_data(DOCUMENT_MAP[key]["link"], temp_agreement)
            
#             # clauses = data_extraction.Clause_extraction_with_summarization(temp_agreement)
